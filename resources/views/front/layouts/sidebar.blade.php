...
<div class="col-md-4 animate-box">
    <div class="sidebar">
        ...
        <div class="side">
            ...
            <div class="f-blog">
                <a href="blog.html" class="blog-img" style="background-image: url({{asset('asset/')}}/images/blog-1.jpg);">
                </a>
                <div class="desc">
            ...
            <div class="f-blog">
                <a href="blog.html" class="blog-img" style="background-image: url({{asset('asset/')}}/images/blog-2.jpg);">
                </a>
                <div class="desc">
                    <p class="admin"><span>18 April 2018</span></p>
                    <h2><a href="blog.html">Creating Mobile Apps</a></h2>
            ...
            <div class="f-blog">
                <a href="blog.html" class="blog-img" style="background-image: url({{asset('asset/')}}/images/blog-3.jpg);">
                </a>
                <div class="desc">
                    <p class="admin"><span>18 April 2018</span></p>
                    <h2><a href="blog.html">Creating Mobile Apps</a></h2>
